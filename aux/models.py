...
class TIME_UTC (ConfigurationModel):
    ...
    f6 = db.Column('INITIAL_CONDITION', ChoiceType([(1, 'NONE'), (2, 'INSERTION'), (3, 'RESTART')]), info = {'label': 'INITIAL_CONDITION'})
...
class METEO_DATA (ConfigurationModel):
    ...
    f1 = db.Column('METEO_DATA_FORMAT', ChoiceType([(1, 'WRF'), (2, 'GFS'), (3, 'ERA5'), (4, 'ERA5ML'), (5, 'IFS'), (6, 'CARRA')]), info = {'label': 'METEO_DATA_FORMAT'})
...
class GRID (ConfigurationModel):
    ...
    f1 = db.Column('HORIZONTAL_MAPPING', ChoiceType([(1, 'CARTESIAN'), (2, 'SPHERICAL')]), info = {'label': 'HORIZONTAL_MAPPING'})
    f2 = db.Column('VERTICAL_MAPPING', ChoiceType([(1, 'SIGMA_NO_DECAY'), (2, 'SIGMA_LINEAR_DECAY'), (3, 'SIGMA_EXPONENTIAL_DECAY')]), info = {'label': 'VERTICAL_MAPPING'})
    ...
    f7 = db.Column('NX', ChoiceType([(1, 'integer'), (2, 'RESOLUTION float')]), info = {'label': 'NX'})
    f8 = db.Column('NY', ChoiceType([(1, 'integer'), (2, 'RESOLUTION float')]), info = {'label': 'NY'})
...
class SPECIES (ConfigurationModel):
    ...
    f3 = db.Column('H2O', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'H2O'})
    f4 = db.Column('SO2', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'SO2'})
    f5 = db.Column('CS134', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'CS134'})
    f6 = db.Column('CS137', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'CS137'})
    f7 = db.Column('I131', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'I131'})
    f8 = db.Column('SR90', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'SR90'})
    f9 = db.Column('Y90', ChoiceType([(1, 'ON MASS_FRACTION_(%) = float'), (2, 'OFF')]), info = {'label': 'Y90'})
...
class SPECIES_TGSD (ConfigurationModel):
    ...
    f5 = db.Column('DISTRIBUTION', ChoiceType([(1, 'GAUSSIAN'), (2, 'BIGAUSSIAN'), (3, 'WEIBULL'), (4, 'BIWEIBULL'), (5, 'CUSTOM'), (6, 'ESTIMATE')]), info = {'label': 'DISTRIBUTION'})
...
class PARTICLE_AGGREGATION (ConfigurationModel):
    ...
    f1 = db.Column('PARTICLE_CUT_OFF', ChoiceType([(1, 'NONE'), (2, 'FI_LOWER_THAN float'), (3, 'FI_LARGER_THAN float'), (4, 'D_(MIC)_LARGER_THAN float'), (5, 'D_(MIC)_LOWER_THAN float')]), info = {'label': 'PARTICLE_CUT_OFF'})
    f2 = db.Column('AGGREGATION_MODEL', ChoiceType([(1, 'NONE'), (2, 'CORNELL'), (3, 'COSTA'), (4, 'PERCENTAGE')]), info = {'label': 'AGGREGATION_MODEL'})
...
class SOURCE (ConfigurationModel):
    ...
    f1 = db.Column('SOURCE_TYPE', ChoiceType([(1, 'POINT'), (2, 'SUZUKI'), (3, 'TOP-HAT'), (4, 'PLUME'), (5, 'RESUSPENSION')]), info = {'label': 'SOURCE_TYPE'})
    ...
    f8 = db.Column('MASS_FLOW_RATE_(KGS)', ChoiceType([(1, 'float_list'), (2, 'ESTIMATE-MASTIN'), (3, 'ESTIMATE-WOODHOUSE'), (4, 'ESTIMATE-DEGRUYTER')]), info = {'label': 'MASS_FLOW_RATE_(KGS)'})
...
class ENSEMBLE (ConfigurationModel):
    ...
    f2 = db.Column('PERTURBATE_COLUMN_HEIGHT', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_COLUMN_HEIGHT'})
    f3 = db.Column('PERTURBATE_MASS_FLOW_RATE', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_MASS_FLOW_RATE'})
    f4 = db.Column('PERTURBATE_SOURCE_START', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_SOURCE_START'})
    f5 = db.Column('PERTURBATE_SOURCE_DURATION', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_SOURCE_DURATION'})
    f6 = db.Column('PERTURBATE_TOP-HAT_THICKNESS', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_TOP-HAT_THICKNESS'})
    f7 = db.Column('PERTURBATE_SUZUKI_A', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_SUZUKI_A'})
    f8 = db.Column('PERTURBATE_SUZUKI_L', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_SUZUKI_L'})
    f9 = db.Column('PERTURBATE_WIND', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_WIND'})
    f10 = db.Column('PERTURBATE_DATA_INSERTION_CLOUD_HEIGHT', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_DATA_INSERTION_CLOUD_HEIGHT'})
    f11 = db.Column('PERTURBATE_DATA_INSERTION_CLOUD_THICKNESS', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_DATA_INSERTION_CLOUD_THICKNESS'})
    f12 = db.Column('PERTURBATE_FI_MEAN', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_FI_MEAN'})
    f13 = db.Column('PERTURBATE_DIAMETER_AGGREGATES_(MIC)', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_DIAMETER_AGGREGATES_(MIC)'})
    f14 = db.Column('PERTURBATE_DENSITY_AGGREGATES', ChoiceType([(1, 'NO'), (2, 'RELATIVE'), (3, 'ABSOLUTE')]), info = {'label': 'PERTURBATE_DENSITY_AGGREGATES'})
...
class MODEL_PHYSICS (ConfigurationModel):
    ...
    f1 = db.Column('LIMITER', ChoiceType([(1, 'MINMOD'), (2, 'SUPERBEE'), (3, 'OSPRE')]), info = {'label': 'LIMITER'})
    f2 = db.Column('TIME_MARCHING', ChoiceType([(1, 'EULER'), (2, 'RUNGE-KUTTA')]), info = {'label': 'TIME_MARCHING'})
    f3 = db.Column('CFL_CRITERION', ChoiceType([(1, 'ONE_DIMENSIONAL'), (2, 'ALL_DIMENSIONS')]), info = {'label': 'CFL_CRITERION'})
    f4 = db.Column('CFL_SAFETY_FACTOR', db.Float, info = {'label': 'CFL_SAFETY_FACTOR'}, default = 0.9)
    f5 = db.Column('TERMINAL_VELOCITY_MODEL', ChoiceType([(1, 'ARASTOOPOUR'), (2, 'GANSER'), (3, 'WILSON'), (4, 'DELLINO'), (5, 'PFEIFFER'), (6, 'DIOGUARDI2017'), (7, 'DIOGUARDI2018')]), info = {'label': 'TERMINAL_VELOCITY_MODEL'})
    f6 = db.Column('HORIZONTAL_TURBULENCE_MODEL', ChoiceType([(1, 'CONSTANT float'), (2, 'CMAQ'), (3, 'RAMS')]), info = {'label': 'HORIZONTAL_TURBULENCE_MODEL'})
    f7 = db.Column('VERTICAL_TURBULENCE_MODEL', ChoiceType([(1, 'CONSTANT float'), (2, 'SIMILARITY')]), info = {'label': 'VERTICAL_TURBULENCE_MODEL'})
...
class MODEL_OUTPUT (ConfigurationModel):
    ...
    f2 = db.Column('LOG_FILE_LEVEL', ChoiceType([(1, 'NONE'), (2, 'NORMAL'), (3, 'FULL')]), info = {'label': 'LOG_FILE_LEVEL'})
    f3 = db.Column('RESTART_TIME_INTERVAL_(HOURS)', ChoiceType([(1, 'float'), (2, 'NONE'), (3, 'END_ONLY')]), info = {'label': 'RESTART_TIME_INTERVAL_(HOURS)'})
    ...
    f6 = db.Column('OUTPUT_TIME_START_(HOURS)', ChoiceType([(1, 'float'), (2, 'RUN_START')]), info = {'label': 'OUTPUT_TIME_START_(HOURS)'})
...
class MODEL_VALIDATION (ConfigurationModel):
    ...
    f1 = db.Column('OBSERVATIONS_TYPE', ChoiceType([(1, 'SATELLITE_DETECTION'), (2, 'SATELLITE_RETRIEVAL'), (3, 'DEPOSIT_CONTOURS'), (4, 'DEPOSIT_POINTS')]), info = {'label': 'OBSERVATIONS_TYPE'})
